                    ...
                    <table id="LessonTable">
                       <thead>
                        ...
                        <tr class="mainTr" >
                            ...
                            <td  class ="exam" data-id='closed' data-label="Εξάμηνο"><?php echo $row["Exam"]; ?></td>
                        ...
                        <div class="content">
                            ...
                            <form id="form1" action="php/addNewLesson.php" method="post">
                                ...
                                <div class="column">
                                    ...
                                    <button id="submitButtonOnAddNewLesson" style="display:none" class="btn" onclick="AddNewLessonPopUp(2)" type="submit" value="Edit"></button>
