<?php
    ...
    if (!empty($_FILES["newWinterPDF"]["name"])) {
        $destination1 .= $Department . "-Winter-";                   //adding the name infront of the file name incase a user uploads a file with the same name of another file 
    ...
    if (!empty($_FILES["newSummerPDF"]["name"])) {
        $destination2 .= $Department . "-Summer-";                    //adding the name infront of the file name incase a user uploads a file with the same name of another file 
