<?php
    ...
    $query = "UPDATE  departmentsinfos SET Department = '$Department' , TotalECTS = $TotalECTS , Site = '$site ', Conditions = '$Conditions',TotalExam = $TotalExam,PathWinter = '$destination1', PathSummer= '$destination2' WHERE id=$id;";
