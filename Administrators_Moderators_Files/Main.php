                            ...
                            <div class="popupAlert1" id="popup-Alert1">
                                ...
                                <div class="contentAlert">
                                    ...
                                    <form id="formDeleteUser" action="php/deleteModerator.php" method="post">
                                        ...
                                        <p>Είσαι σίγουρος πως θέλεις να διαγράψεις τον διαχειριστή με όνομα:</p>
                                        <p id="moderatorName"></p>

                                        <button class="btn" onclick="deleteModeratorPopUp()" type="submit" value="Edit">Διαγραφή</button> 
                                        <button class="btn2" onclick="deleteModeratorPopUp()" type="button" value="Edit">Κλείσιμο</button> 
                            ...
                            <div class="popupEditModerator" id="popup-EditModerator">
                                ...
                                <div class="content">
                                    ...
                                    <form id="formEditUser" action="php/editModerator.php" method="post">
                                        ...
                                        <div>
                                            <button class="btn" onclick="editModerator()" type="submit" value="Edit">Αποθήκευση</button>
                                            <button class="btn2"  onclick="editModerator()" type="button">Κλείσιμο</button>
                                        </div>
                            ...
                            <div class="popupAddModerator" id="popup-AddModerator">
                                ...
                                <div class="content">
                                    ...
                                    <form id="AddModeratorForm" action="php/addModerator.php" method="post">
                                        ...
                                        <button style="display:none" class="btn" id="submitButtonOnAddNewUser"  onclick="addModerator()" type="submit" ></button>
                    ...
                    <table id="INFOSTable">
                                            ...
                                            <table id="CollapsibleTable"  style="padding-left:0px;" >
                                                <tbody>
                                                    ...
                                                    <tr data-id="infos" >
                                                        ...
                                                        <td style="background:#F0F0F0; font-size:15px;"  width="75%"><a href="<?php echo $row["PathWinter"]; ?>" target="_blank">Χειμερινό Εξάμηνο</a></td>
                                                    </tr>
                                                    <?php  if($row["PathSummer"] != "-"){?>
                                                    <tr data-id="infos" >
                                                        <td style=" background:#F0F0F0; color:#06817F; font-size:15px;"  width="25%"><p>Εαρινό Εξαμ.</p></td>
                                                        <td style="background:#F0F0F0; font-size:15px;"  width="75%"><a href="<?php echo $row["PathSummer"]; ?>" target="_blank">Εαρινό Εξάμηνο</a></td>
                                                    </tr>
                                                    <?php } ?>
                            ...
                            <div class="popupAlert2" id="popup-Alert2">
                                ...
                                <div class="contentAlert">
                                    ...
                                    <form id="" action="php/deleteInfos.php" method="post">
                                        ...
                                        <button class="btn" onclick="deleteINFOS(2)" type="submit" value="Edit">Διαγραφή</button> 
                                        <button class="btn2" onclick="deleteINFOS(2)" type="button" value="Edit">Κλείσιμο</button> 
                                    </form>
                                </div>
                            </div>
                            <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
                            ...
                            <div class="popupEdiINFOS" id="popup-EdiINFOS" >
                                ...
                                <div class="content">
                                    ...
                                    <div class="column" >
                                        ...
                                        <p><b>ECTS</b></p>
                                        <input step="1"  autocomplete="off" type="number" min="0" max="100" name="ECTSonEdit" id="ECTSonEdit" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" >
                                        
                                        <p><b>Εξάμηνα</b></p>
                                        <input step="1"  autocomplete="off" type="number" min="0" max="10" name="ExamOnEdit" id="ExamOnEdit" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" >

                                        <button class="btn" onclick="checkNewInfoOnEdit()" type="button" >Αποθήκευση</button>

                                        <button  class="btn2" onclick="editINFOS(2)" id="submitButtonOnEditInfo" type="button" >Κλείσιμο</button>

                                        <button style="display:none" class="btn" onclick="editINFOS(2)" id="submitButtonOnEditInfo" type="submit" value="Edit"></button>
                            ...
                            <div class="popupAddINFOS" id="popup-AddINFOS">
                                ...
                                <div class="content">
                                    ...
                                    <form id="formAddPDF" action="php/addNewDepartment-PDF.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="column"> 
                                            ...
                                            <input  type="text" name="DepartmentOnAdd" id="DepartmentOnAdd">
                                        ...
                                        <div class="column"> 
                                            <p><b>ECTS</b></p>
                                            <input step="1"  autocomplete="off" type="number" min="0" max="100" name="ECTSonADD" id="ECTSonADD" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" >
                                            
                                            <p><b>Εξάμηνα</b></p>
                                            <input step="1"  autocomplete="off" type="number" min="0" max="10" name="ExamOnADD" id="ExamOnADD" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" >

                                            <label for="ADDnewSite"><b>Site Τμήματος</b></label>
                                            <input type="url" id="ADDnewSite" name="ADDnewSite">

                                            <button  class="btn" onclick="checkNewInfo()" type="button" >Αποθήκευση</button>
                                            <button  class="btn2" onclick="checkNewInfo()" type="button" >Κλείσιμο</button>

                                            <button style="display:none" class="btn" id="submitButtonOnAddNewInfo" onclick="addINFOS(2)" type="submit" value="Edit"></button>
